  ...
  return (
    <div className="card-interro">
      ...
      <div className='mode-content'>
        <p id="fiContent" className={activeButton === 'fiContent' ? 'active-content' : ''}>
          Le mode Facile is simply dummy text of the printing and typesetting.
        </p>
        <p id="miContent" className={activeButton === 'miContent' ? 'active-content' : ''}>
          Le mode Moyen is simply dummy text of the printing and typesetting.
        </p>
        <p id="diContent" className={activeButton === 'diContent' ? 'active-content' : ''}>
